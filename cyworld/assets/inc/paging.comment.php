...
<div class="paging_wrap">
    <ul>
        ...
        if( $startPageBlockNum > 1 ){
            ?>
            <li><a class="page_arrow" href="./view.php?page_num=1&seq=<?php echo $seq ?>"><<</a></li>
            <li><a class="page_arrow" href="./view.php?page_num=<?php echo $startPageBlockNum-5; ?>&seq=<?php echo $seq ?>"><</a></li>
            <?php
        }
        ?>
        ...
        for( $i=0; $i<$loopCnt; $i++){
            ...
            ?><li ><a class="<?php echo $pointClass; ?>" href="./view.php?page_num=<?php echo $currPage; ?>&seq=<?php echo $seq ?>"><?php echo $currPage; ?></a></li>
        <?php } ?>

        <?php
        if( $lastPageBlockNum < ceil( $pageCnt ) ){
            ?>
            <li><a class="page_arrow" href="./view.php?page_num=<?php echo $lastPageBlockNum+1; ?>">></a></li>
            <li><a class="page_arrow" href="./view.php?page_num=<?php echo ceil( $pageCnt ); ?>">>></a></li>
            <?php
        }
        ?>
    </ul>
